                            ...
                            <tr class="odd gradeX" align="center">
                                ...
                                <?php
                                    ...
                                    if($count > 3){ ?>
                                        ...
                                        <i class="fa fa-cubes fa-fw"></i><a href="?action=addProductToTitle&id=<?php echo $key['title_id']; ?>"> Add Product</a>

                                        | <i class="fa fa-bars fa-fw"></i> <a href="?action=showListProduct&id=<?php echo $key['title_id']; ?>"> Products List</a>
                                        |
