...
<script type="text/javascript">
		...
		function validate(){
				...
				if(user.length == 0 || user ==" ") {
					...
					document.getElementById('alert-name').style.color = "#f00";
					return false;
				}
				...
				if(pass1.length == 0) {
					...
					document.getElementById('alert-pass').style.color = "#f00";
					return false;
				}
				...
				if(pass2 != pass1) {
					...
					document.getElementById('alert-pass2').style.color = "#f00";
					return false;
				}else{
				...
				if(name.length == 0 || name ==" ") {
					...
					document.getElementById('alert-fname').style.color = "#f00";
					return false;
				}
				...
				if(email.length == 0) {
					...
					document.getElementById('alert-email').style.color = "#f00";
					return false;
				}
				...
				if(t.length < 15) {
					...
					document.getElementById('alert-address').style.color = "#f00";
					return false;
				}else{
				...
				if(tel.length == 0) {
                    ...
                    document.getElementById('alert-tel').style.color = "#f00";
					return false;
					return false;
