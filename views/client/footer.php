        ...
        <div class="container">
            <div class="row">
                <div class="socials menu-center">
                    <p>Connect with us</p>
                    <div>
                        <a target="_blank" href=""><img width="24px" height="24px" src="../controller/public/client/images/icon/f.png"></a>
                        <a target="_blank" href=""><img width="24px" height="24px" src="../controller/public/client/images/icon/g+.png"></a>
                        <a target="_blank" href=""><img width="24px" height="24px" src="../controller/public/client/images/icon/tw.png"></a>
                    </div>
            	</div>
                    <div class="row">
